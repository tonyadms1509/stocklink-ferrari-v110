...
import { XMarkIcon, MagnifyingGlassIcon, CubeIcon, CameraIcon } from '@heroicons/react/24/solid';
                ...
                <div className="p-6 space-y-5">
                    <div className="relative">
                        ...
                        {searchTerm && !selectedProduct && filteredProducts.length > 0 && (
                            <ul className="absolute z-10 w-full bg-white/95 backdrop-blur-md border border-gray-200 rounded-lg mt-1 max-h-60 overflow-y-auto shadow-xl">
