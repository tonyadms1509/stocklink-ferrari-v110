...
const WeatherWidget: React.FC<{ condensed?: boolean }> = ({ condensed = false }) => {
    ...
    useEffect(() => {
        ...
        // 2. Simulate Load Shedding Stage (Mock logic: Higher stages in evening)
        // In a real app, this would connect to the EskomSePush API
    ...
    return (
        <div className="bg-gradient-to-br from-blue-400 to-blue-600 p-6 rounded-xl shadow-md text-white border border-white/10">
            <div className="flex justify-between items-start mb-4">
                <h4 className="font-bold flex items-center gap-2"><CloudIcon className="h-5 w-5"/> Site Conditions</h4>
