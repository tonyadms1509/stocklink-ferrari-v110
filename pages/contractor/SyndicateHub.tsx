            ...
            <div className="bg-slate-900/80 p-8 text-white relative">
                ...
                <div className="relative z-10 flex justify-between items-start gap-4">
                    <div>
                        ...
                        <h3 className="text-3xl font-black italic uppercase tracking-tighter text-white leading-none">{syndicate.productName}</h3>
            ...
            <div className="bg-slate-950 rounded-[3rem] p-16 text-white shadow-2xl relative overflow-hidden border border-white/5">
                ...
                <div className="relative z-10 flex flex-col md:flex-row justify-between items-center gap-12">
                    <div className="text-left max-w-2xl">
                        ...
                        <h1 className="text-7xl font-black tracking-tighter italic uppercase mb-8 leading-none">Syndicate <span className="text-blue-500">Hub</span></h1>
