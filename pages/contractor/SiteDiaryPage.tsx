                                    ...
                                    <div className="flex-grow text-left">
                                        <div className="flex justify-between items-start mb-4">
                                            <div>
                                                ...
                                                <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Transmission: {log.date.toLocaleTimeString()}</p>
                                            </div>
                                        ...
                                        <p className="text-slate-700 leading-relaxed italic font-serif text-lg">"{log.content}"</p>
