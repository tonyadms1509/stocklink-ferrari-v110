    ...
    useEffect(() => {
        return () => {
            if (abortControllerRef.current) {
                abortControllerRef.current.abort("Page Navigation");
            }
        };
    }, []);
        ...
        <div className="space-y-12 animate-fade-in font-sans pb-24 text-left selection:bg-red-600/30">
            <header className="flex flex-col md:flex-row justify-between items-start md:items-end gap-10 border-b border-white/5 pb-12">
                <div className="text-left">
                    ...
                    <p className="text-slate-500 mt-6 font-mono text-sm tracking-widest uppercase italic max-w-2xl leading-relaxed text-left">"Autonomous delivery verification. Sync visual sensor feeds from delivery notes to project structural dossiers."</p>
                </div>
                {onBack && (
