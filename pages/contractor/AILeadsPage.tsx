...
const AILeadsPage: React.FC<AILeadsPageProps> = ({ onNavigate, onBack }) => {
    /* Fix: use correct method and state from context */
    ...
    // Mock match score calculator based on type (for demo visual)
        ...
        <div className="pb-12 text-left">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
                <div className="text-left">
                    ...
                    <p className="text-gray-600 mt-1">{t('aiLeadsDescription')}</p>
                </div>
                <button 
                    onClick={() => generateDailyBriefing(true)} 
                    /* Fix: use leads property of loading object */
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="text-left">
                                    ...
                                    <h4 className="font-bold text-lg text-gray-900 leading-tight mb-3 group-hover:text-primary transition-colors text-left">{lead.title}</h4>
                                    
                                    <div className="text-sm text-gray-500 space-y-2 mb-4 text-left">
                                    ...
                                    <p className="text-sm text-gray-600 line-clamp-3 mb-4 bg-gray-50 p-3 rounded-lg border border-gray-100 italic text-left">
                                        "{lead.summary}"
                                    </p>
                                </div>
