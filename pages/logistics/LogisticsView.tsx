                ...
                <div className="space-y-12 animate-fade-in">
                    ...
                    <div className="bg-gradient-to-r from-blue-700 via-blue-600 to-indigo-700 rounded-[4rem] p-12 text-white shadow-2xl relative overflow-hidden group border-4 border-slate-950">
                            ...
                            <div className="text-left max-w-2xl">
                                ...
                                <p className="text-blue-50 text-xl font-medium italic leading-relaxed">"Invite fellow carriers or suppliers to the grid. Secure a R50.0 dispatch credit for your next fleet maintenance or subscription cycle when their node synchronizes with a paid plan."</p>
                            </div>
                            <button 
                    ...
                    <div className="bg-slate-900 border border-white/5 rounded-[4rem] p-16 text-white shadow-2xl relative overflow-hidden group">
                        ...
                        <div className="relative z-10 max-w-3xl text-left">
                            ...
                            <p className="text-slate-400 text-2xl leading-relaxed font-medium italic opacity-80">"Predictive route optimization locked. Real-time driver telemetry established for 142 metropolitan nodes. System integrity verified."</p>
