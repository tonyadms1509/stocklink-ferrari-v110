...
import { Supplier, PayoutDetails, SystemStatus } from '../../types.ts';
import { 
...
import BusinessVerification from '../../components/BusinessVerification.tsx';
    ...
    <div className="pb-20 animate-fade-in font-sans">
                   ...
                   <div className="flex gap-4 w-full lg:w-auto">
                        {!isEditMode ? (
                            ...
                            <div className="flex gap-4 w-full">
                                <button type="button" onClick={() => setIsEditMode(false)} className="flex-1 bg-white/5 hover:bg-white/10 text-slate-500 font-black py-4 px-10 rounded-3xl uppercase tracking-widest text-[10px]">Abort</button>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
        ...
        <div className="lg:col-span-8 space-y-10">
            <form onSubmit={handleProfileSubmit} className="space-y-10 text-left">
        ...
        <div className="lg:col-span-4 space-y-10 text-left">
            <div className={`rounded-[3rem] p-10 text-white shadow-2xl relative overflow-hidden group transition-all duration-1000 ${systemStatus === SystemStatus.Production ? 'bg-emerald-600 shadow-emerald-900/40' : 'bg-slate-900 border border-white/5'}`}>
                 ...
                 <div className="relative z-10 text-left">
                    ...
                    <h3 className="text-3xl font-black italic uppercase tracking-tighter mb-4 leading-none text-left">
                        {systemStatus === SystemStatus.Production ? 'Ferrari Live' : 'Launch Ferrari'}
                    </h3>
                    <p className={`text-sm font-medium leading-relaxed mb-10 text-left ${systemStatus === SystemStatus.Production ? 'text-emerald-50' : 'text-slate-400'}`}>
            ...
            <div className="bg-slate-950 p-10 rounded-[3rem] shadow-2xl text-white relative overflow-hidden group border border-white/5 text-left">
                ...
                <h3 className="text-xl font-black italic uppercase tracking-tighter mb-8 flex items-center gap-4 relative z-10 text-left">
                ...
                <div className="relative z-10 text-left">
                    {formData.payoutDetails ? (
                        <div className="space-y-6">
                            <div className="bg-white/5 p-6 rounded-[2rem] border border-white/5 group hover:bg-white/10 transition-all text-left">
                                <p className="text-[9px] text-slate-500 uppercase font-black mb-1 tracking-widest">Clearing Terminal</p>
                                <p className="font-black italic text-emerald-400 text-xl tracking-tight uppercase text-left">{formData.payoutDetails.bankName}</p>
                            </div>
                            <div className="bg-white/5 p-6 rounded-[2rem] border border-white/5 group hover:bg-white/10 transition-all text-left">
                                <p className="text-[9px] text-slate-500 uppercase font-black mb-1 tracking-widest">Active Ledger</p>
                                <p className="font-mono font-bold text-lg text-left">**** {formData.payoutDetails.accountNumber.slice(-4)}</p>
                            </div>
            ...
            <div className="bg-white p-10 rounded-[3.5rem] shadow-sm border border-slate-200 text-center relative overflow-hidden group hover:border-blue-500/30 transition-all">
                ...
                <div className="inline-block bg-white p-6 rounded-[2.5rem] shadow-2xl border-8 border-slate-900 mb-10">
      ...
      <div className="fixed bottom-10 right-10 pointer-events-none opacity-5 -z-10 rotate-90 select-none text-left">
          <span className="text-[140px] font-black tracking-tighter text-slate-900 uppercase italic leading-none">FERRARI OPS</span>
      </div>
    </div>
  );
};
