...
const MarketPulsePage: React.FC = () => {
    ...
    // Removed marketPulseResponse as it does not exist on DataContextState
    ...
    return (
        <div className="space-y-12 font-sans pb-20 selection:bg-blue-50/30 text-left">
                ...
                <div className="lg:col-span-4">
                    <div className="bg-slate-900 p-10 rounded-[3rem] shadow-2xl text-white relative overflow-hidden border border-white/5">
                        ...
                        <form onSubmit={handleMarketScan} className="space-y-8 relative z-10 text-left">
                            <div>
                                <label className="block text-[10px] font-black uppercase tracking-widest text-slate-500 mb-3">Technical Identifier</label>
                                <input 
                                    type="text" 
                                    value={productQuery}
                            ...
                            <button 
                                ...
                                className="w-full bg-blue-600 hover:bg-blue-500 text-white font-black py-6 rounded-3xl shadow-2xl shadow-blue-900/40 transition-all flex items-center justify-center gap-4 uppercase tracking-[0.3em] text-xs transform active:scale-95 disabled:opacity-50 border border-white/10"
                            >
