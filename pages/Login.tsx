...
const Login: React.FC<LoginProps> = ({ onSwitchToSignUp }) => {
  /* Fix: destructure startTestDrive correctly from useAuth hook */
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    setError('');
    /* Fix: corrected arguments to login call to include both email and password */
  ...
  return (
    <div className="min-h-screen flex bg-slate-950 font-sans selection:bg-red-600/30">
      ...
      {/* Right Side - Immersive Ferrari Content */}
            ...
            <div className="holographic-glass p-16 rounded-[4rem] border-white/5 shadow-2xl max-w-3xl transform -rotate-1">
                ...
                <div className="flex gap-6">
                    ...
                    <div className="flex items-center gap-3 bg-white/5 px-6 py-3 rounded-2xl border border-white/10">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-300">Core: v80.5</span>
                    </div>
                </div>
            </div>
        </div>
