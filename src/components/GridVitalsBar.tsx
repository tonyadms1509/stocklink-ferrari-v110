...
const VitalItem = ({ label, value, trend, icon: Icon, color }: any) => (
    <div className="flex items-center gap-4 px-8 border-r border-white/5 h-full group hover:bg-white/5 transition-colors cursor-help shrink-0">
        <div className={`p-2 rounded-lg ${color} bg-opacity-10 group-hover:scale-110 transition-transform shadow-lg`}>
                ...
                <div className="flex items-center gap-3">
                    {isGridSaturated ? (
                        <div className="flex items-center gap-2 text-red-500 animate-pulse">
                            ...
                            <span className="text-[9px] font-black uppercase tracking-widest">Nodes Cooling</span>
                        </div>
                    ) : (
                        <div className="flex items-center gap-2">
                             <div className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse shadow-[0_0_8px_#10b981]"></div>
                             <span className="text-[9px] font-black uppercase tracking-widest text-slate-400">Sync: LOCKED</span>
                        </div>
                    )}
                </div>
            </div>
