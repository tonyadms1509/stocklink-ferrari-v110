...
const AIProjectAssistant: React.FC<AIProjectAssistantProps> = ({ project }) => {
    ...
    const handleSendMessage = async (e: React.FormEvent) => {
        ...
        try {
            ...
            Keep answers concise and professional. Use markdown for formatting (bolding key figures).`;
    ...
    return (
        <div className="flex flex-col h-[500px] bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            <div className="p-4 border-b bg-gray-50 flex items-center justify-between">
                ...
                <span className="text-xs bg-purple-100 text-purple-700 px-2 py-0.5 rounded-full font-bold">Beta</span>
            </div>
             ...
             <div className="p-3 bg-white border-t border-gray-100">
                ...
                <form onSubmit={handleSendMessage} className="flex items-center gap-2 relative">
                    <input
                        ...
                        placeholder="Ask about budget, orders, or materials..."
