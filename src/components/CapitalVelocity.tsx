        ...
        <div className="bg-slate-900 border border-white/10 p-12 rounded-[4rem] shadow-2xl relative overflow-hidden group text-left">
            ...
            <div className="relative z-10 flex flex-col lg:flex-row gap-16 items-center">
                <div className="text-left flex-grow">
                    ...
                    <h2 className="text-6xl font-black text-white italic tracking-tighter uppercase leading-none mb-10">Capital <span className="text-emerald-500">Velocity</span></h2>
                    
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-12">
                         <div className="bg-slate-950 p-8 rounded-[2.5rem] border border-white/5 relative overflow-hidden group/box">
