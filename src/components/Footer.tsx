...
const Footer: React.FC = () => {
    return (
        <footer className="bg-slate-950 text-slate-400 py-16 border-t border-white/5 relative overflow-hidden no-print">
            {/* Background Texture */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-20">
                    ...
                    <div className="md:col-span-5 space-y-6">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-2xl font-black italic uppercase tracking-tighter text-white">StockLink <span className="text-blue-600">Ferrari</span></span>
                        </div>
                        ...
                        <div className="flex items-center gap-4 pt-4">
                            ...
                            <span className="text-[9px] font-black text-slate-600 uppercase tracking-[0.4em]">Build v62.3.0_PROD</span>
                        </div>
                    </div>
                    ...
                    <div className="md:col-span-3 space-y-6">
                        ...
                        <ul className="space-y-3 text-sm font-bold uppercase tracking-widest">
                            <li><a href="#/terms" className="hover:text-blue-500 transition-colors">SLA Protocols</a></li>
                            <li><a href="#/privacy" className="hover:text-blue-500 transition-colors">Privacy Handshake</a></li>
                            <li><a href="#/help" className="hover:text-blue-500 transition-colors">System Manual</a></li>
                            <li><a href="#/billing" className="hover:text-blue-500 transition-colors">Registry Billing</a></li>
                        </ul>
                    </div>
                    ...
                    <div className="md:col-span-4 space-y-6">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-start gap-4 group cursor-pointer">
                                <div className="p-2 bg-white/5 rounded-lg border border-white/10 text-blue-500 group-hover:bg-blue-600 group-hover:text-white transition-all">
                            ...
                            <div className="flex items-start gap-4 group cursor-pointer">
                                ...
                                <div>
                                    ...
                                    <a href="mailto:contact@stocklinksa.co.za" className="text-sm font-bold text-slate-200 hover:text-blue-500 transition-colors">contact@stocklinksa.co.za</a>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4 group cursor-pointer">
                                ...
                                <div>
                                    ...
                                    <a href="https://www.stocklinksa.co.za" target="_blank" rel="noopener noreferrer" className="text-sm font-bold text-slate-200 hover:text-blue-500 transition-colors">www.stocklinksa.co.za</a>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4 group cursor-pointer">
                                ...
                                <div>
                                    ...
                                    <a href="tel:+27671875500" className="text-sm font-bold text-slate-200 hover:text-blue-500 transition-colors">+27 (0) 67 187 5500</a>
                                </div>
                            </div>
                        </div>
                    </div>
