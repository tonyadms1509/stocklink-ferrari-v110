...
export type Role = 'contractor' | 'supplier' | 'admin' | 'driver' | 'logistics' | 'marketer';
...
export interface GridWindow {
  id: string; stage: number; startTime: Date; endTime: Date; status: string; impactLevel: string;
}
