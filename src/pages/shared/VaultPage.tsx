...
const MilestoneStrip: React.FC<{ milestone: any; onVerify: () => void; onRelease: () => void }> = ({ milestone, onVerify, onRelease }) => {
    ...
    return (
        <div className="bg-slate-900/50 border border-white/5 p-8 rounded-[2.5rem] flex flex-col md:flex-row items-center justify-between gap-8 group hover:bg-slate-900 transition-all duration-300">
            ...
            <div className="flex items-center gap-12 w-full md:w-auto justify-between md:justify-end">
                ...
                {milestone.status === 'In Verification' && (
                    <button 
                        onClick={onRelease}
                        className="bg-emerald-600 hover:bg-emerald-500 text-white font-black py-4 px-10 rounded-2xl text-xs uppercase tracking-widest shadow-2xl shadow-emerald-900/40 transition-all transform active:scale-95 border border-white/10"
                    >
                        Execute Settlement
                    </button>
                )}
...
const VaultPage: React.FC = () => {
    ...
    return (
        <div className="bg-slate-950 min-h-screen -m-8 p-8 text-slate-200 font-sans selection:bg-red-600/30">
                ...
                <div className="flex flex-col md:flex-row justify-between items-end gap-10 border-b border-white/5 pb-12">
                    <div>
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <span className="text-[10px] font-black uppercase tracking-[0.5em] text-red-500">Fiscal Assurance Core v75.0</span>
                        </div>
                        ...
                        <p className="text-slate-500 mt-4 font-mono text-sm tracking-widest uppercase">Multi-Party Escrow & Neural Audit Engine</p>
                    </div>
                    <div className="flex gap-6">
                        <div className="bg-slate-900 border border-white/10 p-10 rounded-[3rem] shadow-2xl min-w-[300px]">
                             <p className="text-[10px] font-black uppercase tracking-[0.3em] text-amber-500 mb-2">Escrow Hold</p>
                             <p className="text-5xl font-black text-white italic tracking-tighter">
                                 <AnimatedNumber value={metrics.inEscrow} format={formatCurrency} />
                             </p>
                        </div>
                        <div className="bg-slate-900 border border-emerald-500/20 p-10 rounded-[3rem] shadow-2xl min-w-[300px]">
                    ...
                    <div className="lg:col-span-8 space-y-10">
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-3 text-[10px] font-black text-slate-500 uppercase bg-white/5 px-4 py-2 rounded-full border border-white/5 shadow-xl">
                                <SparklesIcon className="h-4 w-4 text-red-500 animate-pulse" />
                                Neural Proof Verification Required
                            </div>
                        </div>
                    ...
                    <div className="lg:col-span-4 space-y-10">
                         <div className="bg-slate-900 rounded-[3.5rem] border border-white/10 p-10 shadow-2xl relative overflow-hidden">
                            ...
                            <h3 className="text-xl font-black italic uppercase tracking-tighter uppercase mb-10 flex items-center gap-4 text-white text-left">
                                ...
                                Recent <span className="text-slate-500">Activity</span>
                            </h3>
                            <div className="space-y-6">
                        ...
                        <div className="bg-red-600 rounded-[3.5rem] p-10 text-white shadow-2xl relative overflow-hidden group border border-white/10">
                             ...
                             <div className="mt-12 flex items-center gap-3">
                                 ...
                                 <span className="text-[10px] font-black uppercase tracking-widest font-mono">GRID SYNC: PROTECTED</span>
                             </div>
                        </div>
                    </div>
                </div>
