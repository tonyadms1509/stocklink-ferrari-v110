...
import { 
    ...
    RadioIcon,
    SignalIcon,
    // Fix: Added missing icon imports to resolve reference errors
    PaperAirplaneIcon,
    TrophyIcon
            ...
            <div className="flex items-center justify-between border-t border-slate-50 pt-6">
                <div className="flex gap-4">
                    ...
                    >
                        ...
                        <span>{post.comments.length} Logged Entries</span>
                    </button>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start max-w-7xl mx-auto w-full">
                ...
                <div className="lg:col-span-3 space-y-8 sticky top-24 hidden lg:block text-left">
                    ...
                    <div className="bg-slate-900 rounded-[2.5rem] p-8 text-white shadow-2xl relative overflow-hidden group border border-white/5">
                        ...
                        <h4 className="font-black italic uppercase tracking-tighter text-xl mb-4 relative z-10 flex items-center gap-3">
                            <TrophyIcon className="h-6 w-6 text-yellow-400"/>
                            Leaderboard
                        </h4>
                        <p className="text-[10px] text-slate-500 uppercase font-black tracking-widest mb-6 relative z-10">Top Verified Nodes</p>
