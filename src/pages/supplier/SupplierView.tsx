...
const SupplierView: React.FC = () => {
  const [activeTab, setActiveTab] = useState<SupplierTab | 'fleet-hub' | 'price-watch' | 'dashboard' | 'vault'>('home');
  ...
  const renderContent = () => {
    if (!user) return null;
    switch (activeTab) {
      case 'home': return <SupplierHome onNavigate={(t) => setActiveTab(t as any)} />;
      ...
      case 'ai-assistant': return <AIInventoryAssistant onNavigate={(t) => setActiveTab(t as any)} />;
      case 'bom-assistant': return <BOMAssistant onNavigate={(t) => setActiveTab(t as any)} />;
      case 'leads': return <SalesLeadsPage onNavigate={(t) => setActiveTab(t as any)} />;
      case 'products': return <ProductManagement onNavigate={(t) => setActiveTab(t as any)} />;
      ...
      case 'messages': return <Messages onNavigate={(t) => setActiveTab(t as any)} onBack={() => setActiveTab('home')} />;
      case 'billing': return <BillingPage />;
      case 'team': return <TeamPage />;
      case 'referrals': return <ReferralsPage />;
      case 'help': return <HelpPage />;
      case 'settings': return <SettingsPage onBack={() => setActiveTab('home')} />;
      default: return <SupplierHome onNavigate={(t) => setActiveTab(t as any)} />;
    }
  };
