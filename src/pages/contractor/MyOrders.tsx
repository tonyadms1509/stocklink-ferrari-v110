...
/** Fix: Resolved useData exported member error from useDataContext module */
...
/** Fix: Ensure useToast is imported for notification handling */
            ...
            <div className="p-6">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-2 text-left">
                    <div className="flex items-center gap-3">
                        ...
                        <div><h3 className="font-bold text-lg text-gray-900">Order #{order.orderNumber}</h3><p className="text-sm text-gray-500">{supplier?.name || order.supplierId}</p></div>
                    </div>
                ...
                <div className="bg-gray-50 px-6 py-4 border-t border-gray-100 animate-fade-in-up">
                    ...
                    <div className="space-y-2">
                        {order.items.map(item => (
                            <div key={item.id} className="flex items-center justify-between gap-4 bg-white p-3 rounded-lg border border-gray-200 shadow-sm">
...
const MyOrders: React.FC<{ onNavigateToCart: () => void; onBack?: () => void; }> = ({ onNavigateToCart, onBack }) => {
    /** Fix: Correctly initialize showToast from useToast and ensure context members are properly destructured */
    ...
    return (
        <>
            <div className="max-w-4xl mx-auto pb-48 lg:pb-12 text-left">
                ...
                <div className="mb-8"><h2 className="text-3xl font-extrabold text-gray-900 tracking-tight">{t('navMyOrders')}</h2><p className="text-gray-500 mt-2">Track and manage your supply deliveries.</p></div>
