...
export const ContractorHome: React.FC<ContractorHomeProps> = ({ onViewSupplier, onStartChat, initialSearchTerm, onClearInitialSearch, showOnlyDeals = false }) => {
    ...
    return (
        <div className="pb-24 space-y-10">
            ...
            {/* Expedition Protocol Header - Clean Masterpiece Style */}
            <div className="bg-slate-900 rounded-[3rem] p-10 text-white shadow-2xl relative overflow-hidden border border-white/10 group">
                ...
                <div className="absolute top-0 right-0 p-8 opacity-10 transform rotate-12 group-hover:rotate-0 transition-transform duration-1000">
                    <Logo className="h-48 w-48 text-white opacity-20" />
                </div>
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-10">
                    <div className="text-left max-w-xl">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <span className="text-[10px] font-black uppercase tracking-[0.5em] text-red-500">National Sync active</span>
                        </div>
                        ...
                        <p className="text-slate-400 text-lg font-medium leading-relaxed italic">"Aggregate requirements with the national grid. Secure high-fidelity procurement offsets for every verified partner synchronization."</p>
                    </div>
                    <button 
