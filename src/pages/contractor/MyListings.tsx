...
import { ArrowLeftIcon, PlusIcon, PencilIcon, TrashIcon, XMarkIcon, SparklesIcon, Package } from 'lucide-react';
        ...
        <div className="animate-fade-in-up">
            ...
            <div className="flex justify-between items-center mb-8">
                ...
                <button onClick={() => setIsModalOpen(true)} className="bg-emerald-600 hover:bg-emerald-500 text-white font-bold py-3 px-6 rounded-xl flex items-center gap-2 shadow-lg transition-all">
                    <PlusIcon className="h-5 w-5" /> List Surplus Stock
                </button>
            </div>
                        ...
                        <div key={p.id} className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200 flex flex-col">
                            ...
                            <div className="flex justify-between items-center pt-4 border-t border-gray-100">
                                ...
                                <div className="flex gap-2">
                                    <button onClick={() => { setEditingProduct(p); setIsModalOpen(true); }} className="p-2 bg-gray-50 text-gray-500 rounded-lg hover:bg-blue-50 hover:text-blue-600 transition-colors"><PencilIcon className="h-4 w-4"/></button>
                                    <button onClick={() => deleteContractorProduct(p.id)} className="p-2 bg-gray-50 text-gray-500 rounded-lg hover:bg-red-50 hover:text-red-600 transition-colors"><TrashIcon className="h-4 w-4"/></button>
                                </div>
                            </div>
                        </div>
                    ))}
