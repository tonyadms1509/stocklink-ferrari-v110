...
import { 
    LayoutGrid, Users, ShieldExclamation, Settings,
    CommandLine, Server, Globe, Activity
} from 'lucide-react';
...
const AdminView: React.FC = () => {
  ...
  const navGroups = [
      ...
      },
      {
          ...
          items: [
              { id: 'disputes', label: 'Dispute Stack', icon: ShieldExclamation },
  ...
  const mobileNavItems = [
      ...
      { id: 'menu', icon: CommandLine, label: 'Menu', action: () => document.dispatchEvent(new CustomEvent('toggle-mobile-menu')) }, 
  ];

  const renderContent = () => {
      switch (activeTab) {
          case 'dashboard': return <AdminDashboard />;
          case 'registry': return <AdminNodeRegistry />;
